            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                    ...
                    <ul>
                        ...
                        <li>有建议请到其它页面留言。</li>
                        <li>在<a href="https://tr.fanfanfan.online/project/p3/files">文本列表</a>页面翻译文本。</li>
                        <li>在<a href="https://tr.fanfanfan.online/project/p3/dicts">用语词典</a>页面增加名词翻译，供自己或其他翻译者查看。</li>
